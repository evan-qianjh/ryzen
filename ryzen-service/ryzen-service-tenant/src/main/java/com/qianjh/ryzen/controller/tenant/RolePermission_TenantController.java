...
import com.qianjh.ryzen.controller.tenant.dto.GetRolePermissionsResp;
import com.qianjh.ryzen.controller.tenant.dto.PostRolePermissionReq;
...
public class RolePermission_TenantController extends _TenantController {
    ...
    public Resp<List<GetRolePermissionsResp>> get(@RequestHeader(GatewayHeaderTenant.OEM_ID) Long oemId,
    ...
    public Resp<?> del(@RequestHeader(GatewayHeaderTenant.OEM_ID) Long oemId,
                       @RequestHeader(GatewayHeaderTenant.TENANT_ID) Long tenantId,
                       @RequestHeader(GatewayHeaderTenant.ACCOUNT_ID) Long accountId,
                       //
