...
public interface AccountTokenService extends IService<AccountToken> {
     ...
     * @return 账户token
     */
    AccessToken generateAccessToken(Long tenantId, RefreshToken refreshToken, RSAPrivateKey privateKey, ClientInfo clientInfo);
     ...
     * @return payload
     */
    RefreshToken parseRefreshToken(Long tenantId, String token, RSAPublicKey publicKey);
}
